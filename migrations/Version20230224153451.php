 ...
 */
final class Version20230224153451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, utilisateur_id INT NOT NULL, text VARCHAR(255) NOT NULL, INDEX IDX_67F068BCFD02F13 (evenement_id), INDEX IDX_67F068BCFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, createur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, nb_des_palces INT NOT NULL, description VARCHAR(255) NOT NULL, statue VARCHAR(50) NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, paiement_valid TINYINT(1) DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_B26681EBCF5E72D (categorie_id), INDEX IDX_B26681E73A201E5 (createur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE home (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lieu (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, ville VARCHAR(50) NOT NULL, adress VARCHAR(50) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salle (id INT AUTO_INCREMENT NOT NULL, lieu_id INT NOT NULL, capacite INT NOT NULL, numero INT NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, discreption VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_4E977E5C6AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
